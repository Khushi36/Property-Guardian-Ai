...
def setup_readonly_user():
    ...
    try:
        ...
        cur.execute("DO $$ BEGIN IF NOT EXISTS (SELECT FROM pg_catalog.pg_user WHERE usename = 'read_only_user') THEN CREATE USER read_only_user WITH PASSWORD 'readonly_password'; END IF; END $$;")
        ...
        cur.execute("ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT ON TABLES TO read_only_user;")
