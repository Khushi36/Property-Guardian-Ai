...
create_pdf(os.path.join(test_dir, "tx1_alice_to_bob.pdf"), [
...
create_pdf(os.path.join(test_dir, "tx2_charlie_to_dave_fraud.pdf"), [
    "State: Himachal Pradesh",
    "District: Shimla",
    "Tehsil: Kumharsain",
    "Village Name: Wakad",
...
create_pdf(os.path.join(test_dir, "tx3_bob_to_eve_valid.pdf"), [
    "State: Himachal Pradesh",
    "District: Shimla",
    "Tehsil: Kumharsain",
    "Village Name: Wakad",
