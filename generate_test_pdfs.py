...
def create_property_pdf(filename, seller_name, seller_aadhaar, seller_pan, buyer_name, buyer_aadhaar, buyer_pan, plot_no, village, date):
    pdf = FPDF()
    pdf.add_page()
    ...
    pdf.multi_cell(0, 10, "This document confirms that the seller has transferred full ownership of the above-mentioned property to the buyer on the date of registration.")
...
create_property_pdf(
    ...
    "Rahul Sharma", "1234-5678-9012", "ABCPS1234A",
    "Sonal Gupta", "9876-5432-1098", "GHTPS9876S",
    "Plot 777", "Baner", "2024-01-15"
)
...
create_property_pdf(
    ...
    "Sonal Gupta", "5555-5555-5555", "FAKEID111X", # <--- Aadhaar mismatch with previous BUYER
    "Vikram Singh", "1111-2222-3333", "VKRAN5555V",
    "Plot 777", "Baner", "2024-03-20"
)
...
create_property_pdf(
    ...
    "Rahul Sharma", "1234-5678-9012", "ABCPS1234A",
    "Priya Das", "7777-8888-9999", "PDAS9999D",
    "Plot 777", "Baner", "2024-04-01"
)
